...
plt.plot(values_male_2, label="Men from meet " + str(default_meetid+1), color='blue')
plt.plot(values_female_1, label="Women from meet " + str(default_meetid), color='pink')
plt.plot(values_female_2, label="Women from meet " + str(default_meetid+1), color='hotpink')
plt.legend()
plt.show()